document.querySelector('.MCD').style.height=`${screen.height}px`;
document.querySelector('.A_MCD_MAIN').style.height=`${screen.height-60}px`;
document.querySelector('.A_MCD_MAIN_SBD').style.height=`${screen.height-100}px`;

document.querySelector('.SUB_PD_M').style.height=`${screen.height-105}px`;
document.querySelector('.ADD_PD_M').style.height=`${screen.height-105}px`;
...
setInterval(()=>{
    ...
    if(document.querySelector('.H').scrollTop != 0 || localStorage.getItem('CT') ==='true'){
        ...
        document.querySelector('.MCD_B').style.height=`${screen.height-50}px`;
        document.querySelector('.H').style.height=`${screen.height-50}px`;
        document.querySelector('.C').style.height=`${screen.height-50}px`;
    }else {
        ...
        document.querySelector('.MCD_B').style.height=`${screen.height-137}px`;
        document.querySelector('.H').style.height=`${screen.height-137}px`;
        document.querySelector('.C').style.height=`${screen.height-137}px`;
    }
